...
/*
    ALGORITHM
        START
            Accept no of rows form user as row
            Accept no of columns from user as column
            Create one couner as iOuter and initialize it to 1
            Create one couner as iInner and initialize it to 1
            iterate till iOuter <= row
                iterate till iInner <= col
                    if iOuter == iInner
                        then print $
                    otherwise if iOuter > iInner
                                    then print #
                    otherwise print *
